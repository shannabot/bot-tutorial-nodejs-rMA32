...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexAll = /^((?!don't be, golden brown!).)*$/gm;
  ...
  if(request.text && botRegexAll.test(request.text) &&(request.name.indexOf("insert name here")>-1 || request.name.indexOf("Rebecca")>-1)) {
    this.res.writeHead(200);
    postMessage("don't be, golden brown!");
    this.res.end();
  }
